...
import multichainResult.MultichainGetInfoResult;
...
public class MultichainQueryBuidlder {
	...
	public static String executeProcess(MultichainCommand command) throws MultichainException{
	...
	public static String createMultichain(String name) {
		...
		try {
			...
			pr = rt.exec("multichain-util create " + name);
	...
	public static String launchMultichainNode(String name) {
		...
		try {
			...
			pr = rt.exec("multichaind " + name + " -daemon");
	 ...
	 */
	public static String execute(MultichainCommand command, String... parameters) throws MultichainException {
		...
		if (!MultichainGlobalValues.CHAIN_NAME.equals("")) {
			...
			throw new MultichainException("", "MultichainGlobalValues.CHAIN_NAME NAME ARE EMPTY !");
		}
	 ...
	 */
	public static String executeGetBlockChainParams() throws MultichainException{
	 ...
	 */
	public static MultichainGetInfoResult executeGetInfo() throws MultichainException{
		
		String JsonResult =  execute(MultichainCommand.GETINFO);
		return new MultichainGetInfoResult(JsonResult);
	}
	 ...
	 *         commands.
	 */
	public static String executeHelp() throws MultichainException{
	 ...
	 * @return
	 */
	public static String executeStop() throws MultichainException{
	 ...
	 */
	public static String executeGetAddresses(boolean verbose) throws MultichainException{
	 ...
	 */
	public static String executeGetNewAddress() throws MultichainException{
	 ...
	 * @param privKey
	 * @param label
	 *            An optional parameter, if you want to set label just send only
	 *            one string
	 * @param rescan
	 *            If rescan is true, the entire blockchain is checked for
	 *            transactions relating to all addresses in the wallet,
	 ...
	 */
	public static String executeListPermissions() throws MultichainException{
	 ...
	 * @param addresses
	 * @param permissions
	 *            This permissions will be revoke to all addresses who are send
	 *            in parameter
	 ...
	 */
	public static String executeListAssets() throws MultichainException{
	 ...
	 *         asset name, ref or issuance txid
	 */
	public static String executeListAssets(boolean verbose) throws MultichainException{
	 ...
	 * @return
	 */
	public static String executeGetMultiBalances() throws MultichainException{
	...
	/**
	 * Returns a list of balances of all the addresses in this node’s wallet with
	 * the specified assets
	 * 
	 * @return
	 * @throws MultichainException
	 ...
	 */
	public static String executeGetTotalBalances() throws MultichainException{
	 ...
	 * @return a list of all the asset balances in this node’s wallet
	 */
	public static String executeGetTotalBalances(boolean includeWatchOnly) throws MultichainException{
	 ...
	 * @return
	 */
	public static String executeListWalletTransaction() throws MultichainException{
	 ...
	 * @return
	 */
	public static String executeCombineUnspent() throws MultichainException{
	 ...
	 * @return
	 */
	public static String executeListLockUnspent() throws MultichainException{
	 ...
	 * @return
	 */
	public static String executeLockUnspent(boolean unlock) throws MultichainException{
	 ...
	 * @return
	 */
	public static String executeGetPeerInfo() throws MultichainException{
	 ...
	 */
	public static void executePing() throws MultichainException{
		execute(MultichainCommand.PING);
	}
	
	
	/**
	 * Returns a base64-encoded digital signature which proves that message was approved by the owner of address 
	 * 
	 * @param address
	 * @param message
	 * @return
	...
	/**
	 * Verifies that message was approved by the owner of address by checking the base64-encoded digital signature provided by a previous call to signmessage. 
	 * @param address
	 * @param signature
	 * @param message
	 * @return
	...
	/**
	 * eturns information about the block with hash (retrievable from getblockhash) or at the given height in the active chain
	 * @param hashOrHeight
	 * @return
	 * @throws MultichainException 
	 */
	...
	/**
	 *  	Removes all unconfirmed transactions from this node’s memory pool. This can only be called after pause incoming,mining. Successful if no error is returned
	 */
	public static String executeClearMemPool() throws MultichainException{
	...
	/**
	 * Rewinds this node’s active chain to height or rewinds/switches to another block with hash.
	 * @param heightOrHash
	 * @return
	 * @throws MultichainException
	 */
